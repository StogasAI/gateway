...
const (
	...
	BifrostContextKeyPreparedRequestBody                 BifrostContextKey = "bifrost-prepared-request-body"                    // providerutils-owned final wire-body descriptor; provider builders must not inspect or modify it
	...
	BifrostContextKeyRequestModelInfo                    BifrostContextKey = "bifrost-request-model-info"                       // RequestModelInfo bound to the exact provider and wire model for request-scoped provider conversion
	...
	BifrostContextKeyHTTPRequestType                     BifrostContextKey = "bifrost-http-request-type"                        // RequestType (set by the HTTP transport; plugins must not modify it)
